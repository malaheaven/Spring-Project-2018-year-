...
$(function(){
	$("#deleteb").click(function(){
		var result = confirm("명소를 삭제 하시겠습니까?");
		if(result){
			window.location.href="deletelocation.do?sights=${locationDTO2.sights}";
		}else{
			window.location.href="locationselect.do?sights=${locationDTO2.sights}";
		}
	});
});
...
<body id="page3">
	<div class="extra">
		...
		<div>
		<br>
		<button type="button" class="button"  style="margin-left: 780px;" id="deleteb">지역명소 삭제</button>
		<br>
		<br>
		</div>
			<div>
